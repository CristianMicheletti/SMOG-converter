...
print "#read_restart restart_file.6000"
...
### XXX Cris, scommentato la parte sotto. togliere dopo verifica
#print ""
#print "#region nanopore (modificato da cylnder)"
#print "#direction(z per forza) / xy position of circle / radius / zdown ztop positions"
#print "#region nanopore  nanopore z 0. 0. 5.8699 -11.739 0. units box"
#print ""
#print "#region where pulling force is applied for every particle inside"
#print "#if the first particle is not in z=0 it might not be pulled so you can extend this region a bit over ztop"
#print "#region nanoporepull cylinder z 0. 0. 5.8699 -11.739 xxxztopxxx units box"
#print ""
#print "#same cylider region of nanopore: use this part if you want to compute the particle in the cylinder which as the highest z"
#print "#region nanoporecyl cylinder z 0. 0. 5.8699 -11.739 0. units box"
#print "#variable npartcyl equal count(all,nanoporecyl)"
#print "#compute idDNA all property/atom id"
#print "#compute idporenetrance all reduce/region nanoporecyl max z c_idDNA replace 2 1"
#print "#variable idporenetrance equal c_idporenetrance[2]"
print ""
...
print ""
print "#repulsive interaction with wall (xxx NC epsilon and sigma and cutoff)"
print "#fix 12 all   wall/region  nanopore  lj126 1. 1. 1.12246152962189"
print "#pulling inside pore if particle is inside region"
print "#fix 14 all    addforce  0. 0. xxxforcevalueofpullingxxx  region nanoporepull"
print ""
